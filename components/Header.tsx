        ...
        <header className="header fixed top-0 left-0 w-full py-4 z-20">
            <div className="container">
                <div className="flex flex-wrap items-center">
                    ...
                    <div className={`header-nav max-lg:fixed max-lg:left-0 max-lg:top-0 max-lg:h-full max-lg:bg-black/70 w-full lg:w-3/4 transition-opacity duration-200 ease-in-out max-lg:opacity-0 max-lg:invisible ${showMenu ? "max-lg:opacity-100 max-lg:visible" : "max-lg:opacity-0 max-lg:invisible" }`}>
